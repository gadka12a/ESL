...
wire [1:0] chunk_insts_3_chunk_insts_4_a;

assign chunk_insts_3_chunk_insts_4_a[1] = k_button_o;
assign chunk_insts_3_chunk_insts_4_a[0] = chunk_insts_3_button_o;
...
always @(posedge clk_i) begin: CLASSIC_FSM_LOC_INSTS_CHUNK_INSTS_1
...
always @(fsm_state) begin: CLASSIC_FSM_LOC_INSTS_CHUNK_INSTS_2_C
    case (fsm_state)
        2'b00: begin
            outputs_o = 1;
        end
...
always @(posedge clk_i) begin: CLASSIC_FSM_LOC_INSTS_CHUNK_INSTS_3_LOC_INSTS_CHUNK_INSTS_K
    if ((inputs_i[0] == chunk_insts_3_prev_button)) begin
        if ((chunk_insts_3_debounce_cnt != 0)) begin
    ...
    chunk_insts_3_prev_button <= inputs_i[0];
end



assign dbnc_inputs = chunk_insts_3_chunk_insts_4_a;
